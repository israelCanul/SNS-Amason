...
public class MessageReceivingService extends Service {
    ...
    protected static void saveToLog(Bundle extras, Context context){
        ...
        for(String key : extras.keySet()){
            ...
            editor.putString("App:MessageLine" + linesOfMessageCount, line);
            linesOfMessageCount++;
        }
    ...
    protected static void postNotification(Intent intentAction, Context context){
        ...
        final PendingIntent pendingIntent = PendingIntent.getActivity(context, 0, intentAction, Notification.DEFAULT_ALL);
        ...
        new AsyncTask(){
            protected Object doInBackground(final Object... params) {
                ...
                try {
                    ...
                    String platformApplicationArn = "arn:aws:sns:us-west-2:026912625031:app/GCM/####_#######";
                    AWSCredentials awsCredentials = new BasicAWSCredentials("##IAJ##TN4Z##2D#####", "####uZq###DrfnMfE2kUX###SbypRHlJM+uC87##");
